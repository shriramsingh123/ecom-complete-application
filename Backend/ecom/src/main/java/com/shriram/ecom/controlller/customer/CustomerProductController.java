package com.shriram.ecom.controlller.customer;

import com.shriram.ecom.dto.ProductDetailDto;
import com.shriram.ecom.dto.ProductDto;
import com.shriram.ecom.services.customer.CustomerProductService;
...
public class CustomerProductController {
    ...
    public ResponseEntity<ProductDetailDto> getProductDetailById(@PathVariable Long productId){
        System.out.println("get product by detail id "+productId);
